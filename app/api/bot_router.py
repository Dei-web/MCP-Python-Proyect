...
#
# # Sistema de prompt
# SYSTEM_PROMPT = """Eres un asistente virtual de "Auto fix", un taller mecánico profesional en Barranquilla, Colombia.
#
...
# - Nombre: Auto fix
# - Ubicación: Av. Principal #123, Barranquilla
...
#
# La ubicación del taller siempre es: "Taller Express - Av. Principal #123, Barranquilla"
# """
#
#
# # Modelos Pydantic
...
# conversaciones = {}
#
# # Definición de herramientas para Claude (usando diccionarios simples)
# TOOLS = [
#     {
#         "name": "buscar_cliente",
...
#             messages=historial,
#             tools=TOOLS,  # Los diccionarios simples funcionan bien
#         )
#
#         # Procesar respuesta
#         respuesta_texto = ""
...
#                 system=SYSTEM_PROMPT,
#                 messages=historial,
#                 tools=TOOLS,  # Los diccionarios simples funcionan bien aquí también
#             )
#
